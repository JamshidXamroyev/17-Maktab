    ...
    <div>
      <div class="bg-black pt-16">
        <div class="w-full px-4 xl:px-0">
          <div class="flex flex-col justify-between grid-cols-4 sm:px-[18px] md:flex-row md:px-10">
            {/* Footer 1 */}
            <div class="md:w-1/4">
              <p class="text-[18px] font-medium text-white">
              <h1 class="text-white font-extrabold">
                <span class="text-rose-600">17</span> Maktab
              </h1>
              </p>
              ...
              <div class="mt-[18px] flex gap-4 text-white justify-between text-[25px]">
                <a class="hover:scale-125 duration-300 gradient" target="_blank" href="/">
            ...
            {/* Footer 2 */}
            <div class="md:w-1/4 md:ml-20">

              <div class="mt-[23px] flex text-white hover:text-gray-400 cursor-pointer">
            ...
            {/* footer 3 */}
            <div class="my-8 flex md:w-1/2 w-full  mx-auto md:justify-around justify-between text-center text-white sm:flex-row md:mt-0">
              <div>
              ...
              <div className="text-center text-white max-md:px-12">
                <p className="text-deutziawhite font-inter text-[18px] font-medium leading-normal">About Dev</p>
                <ul>
                  <li class="mt-[15px]"><a
                      class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                      href="/">Portfolio</a>
